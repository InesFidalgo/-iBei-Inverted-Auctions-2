...
//FACEBOOK!!!!!!!!!!!!!!!!
public class LogAdmin extends ActionSupport implements SessionAware
{
	...
	public LogAdminBean getLoginBean()
	{
		if(!session.containsKey("loginBeanF"))
		{
			this.setLoginBean(new LogAdminBean());
		}
		return (LogAdminBean) session.get("loginBean");
	}

	public void setLoginBean(LogAdminBean loginBean)
	{
