...
public interface RMI extends Remote, Serializable{
	...
	public boolean LoginFacebookInside(String nome, String ID) throws RemoteException;
	public boolean LoginFacebookAdmin(String nome, String ID) throws RemoteException;
