...
import rmi.Leilao;
import FacebookLogin.LoginBean;
//---------------------------------
...
public class login extends ActionSupport implements SessionAware
{
	...
	public void setService()
	{
	    ...
	    this.service = new ServiceBuilder()
	                                  ...
	                                  .apiKey(apiKey)
	                                  .apiSecret(apiSecret)
	                                  .callback("http://localhost:8080/CRLSD/loginFacebook.action") 
	                                  // Do not change this.
	...
	public String execute() throws URISyntaxException, IOException{
		...
		else
		{
		    ...
		    if (this.getLoginBean().tryLogin() == 1)
		    {
		    	System.out.println("imprime no login1");
		    	return "loginFaceFail";
		    	
		    }
		    if (this.getLoginBean().tryLogin() == 2)
		    {
		    	System.out.println("imprime no login2");
		    	return "loginFaceSuccess3";
		    	
		    }
		    if (this.getLoginBean().tryLogin() == 3)
		    {
		    	System.out.println("imprime no login3");
		    	return "loginFaceSuccess4";
	...
	public LoginBean getLoginBean()
	{
		...
		return (LoginBean) session.get("loginBeanF");
	}
